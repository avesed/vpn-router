...
pub use messages::{
    ...
    extract_client_public_key, extract_client_random, extract_server_cipher_suite,
    extract_server_public_key, extract_session_id, write_record_header, DEFAULT_ALPN_PROTOCOLS,
};
