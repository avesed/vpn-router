//! Core iptables management for TUN + TPROXY bridge
//!
//! This module manages the iptables and routing rules required for TPROXY transparent proxying.
//! It is the canonical location for `IptablesManager` -- other modules should import from here.
//!
//! # Overview
//!
...
///
/// ```ignore
/// use rust_router::netbridge::kernel::iptables_core::IptablesManager;
///
/// let manager = IptablesManager::new("tun-in", "10.25.0.0/24", 7893, 0x1, 100)?;
///
/// // Apply rules
/// manager.apply_rules()?;
///
