...
var (
	// NOTE: kcpHeaderLoader removed for binary size reduction (Phase XL.3)
...
// KCPConfig is a stub - mKCP transport has been removed for binary size reduction (Phase XL.3)
...
// Build implements Buildable - returns error as mKCP has been removed
func (c *KCPConfig) Build() (proto.Message, error) {
	return nil, errors.New("mKCP transport has been removed for binary size reduction. Use XHTTP instead.")
}
...
// WebSocketConfig is a stub - WebSocket transport has been removed for binary size reduction (Phase XL.3)
...
// Build implements Buildable - returns error as WebSocket has been removed
func (c *WebSocketConfig) Build() (proto.Message, error) {
	return nil, errors.New("WebSocket transport has been removed for binary size reduction. Use XHTTP instead.")
}

// HttpUpgradeConfig is a stub - HTTPUpgrade transport has been removed for binary size reduction (Phase XL.3)
...
// Build implements Buildable - returns error as HTTPUpgrade has been removed
func (c *HttpUpgradeConfig) Build() (proto.Message, error) {
	return nil, errors.New("HTTPUpgrade transport has been removed for binary size reduction. Use XHTTP instead.")
}
...
func (p TransportProtocol) Build() (string, error) {
	...
	// NOTE: The following transports have been removed for binary size reduction (Phase XL.3)
	case "kcp", "mkcp":
		return "", errors.PrintRemovedFeatureError("mKCP transport", "XHTTP")
	case "grpc":
		return "", errors.PrintRemovedFeatureError("gRPC transport", "XHTTP stream-up H2")
	case "ws", "websocket":
		return "", errors.PrintRemovedFeatureError("WebSocket transport", "XHTTP H2 & H3")
	case "httpupgrade":
		return "", errors.PrintRemovedFeatureError("HTTPUpgrade transport", "XHTTP H2 & H3")
	case "h2", "h3", "http":
...
func (c *StreamConfig) Build() (*internet.StreamConfig, error) {
	...
	case "reality":
		if config.ProtocolName != "tcp" && config.ProtocolName != "splithttp" {
			return nil, errors.New("REALITY only supports RAW and XHTTP.")
		}
